...
var collection = "j";
var cartArray = [];
var imageCountPerColumn = Math.floor(21 / 3); 
//Idea for improvement: find way to scale the algorithm dynamically, if new pictures are uploaded
...
function drawImagePane() {
  ...
  //assign modal close functionality
